            ...
            <tbody>
                ...
                <c:forEach var="salary" items="${salaries}" varStatus="status">
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="salary_action"><a href="<c:url value='/salary/show?id=${salary.id}' />">詳細を見る</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
        ...
        <div id="pagination">
            ...
            <c:forEach var="i" begin="1" end="${((salaries_count - 1) / 15) + 1}" step="1">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="<c:url value='/topPage/index?page=${i}' />"><c:out value="${i}" /></a>&nbsp;
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        </div>
